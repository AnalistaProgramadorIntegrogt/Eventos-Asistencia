...
export const AVAILABLE_PERMISSIONS = [
  ...
  { id: 'ASSIGN_BULK_CATEGORY', name: 'Asignar Categoría Masivamente a Invitados', category: 'Invitados' },
  { id: 'ASSIGN_GUEST_CATEGORY', name: 'Asignar o Modificar Categoría Interna', category: 'Invitados' },
...
export const PERMISSIONS = {
  ...
  ASSIGN_BULK_CATEGORY: [ROLES.SUPER_ADMIN, ROLES.ADMIN],
  ASSIGN_GUEST_CATEGORY: [ROLES.SUPER_ADMIN, ROLES.ADMIN],
