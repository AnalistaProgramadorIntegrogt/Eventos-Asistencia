        ...
        if (res.success && res.data) {
          ...
          if (res.data.form_config) {
            setFormConfig({
              ...
              header_brand_text: res.data.form_config.header_brand_text !== undefined ? res.data.form_config.header_brand_text : '',
              ...
              event_tagline: res.data.form_config.event_tagline !== undefined ? res.data.form_config.event_tagline : '',
